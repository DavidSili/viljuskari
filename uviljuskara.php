...
<?php
if(isset($_GET['a'])) {
		if(isset($_POST['a_vrsta'])) $vrsta=mysqli_real_escape_string($msqli,$_POST['a_vrsta']);
			else $vrsta="";
		if(isset($_POST['a_vlasnik'])) $vlasnik=mysqli_real_escape_string($msqli,$_POST['a_vlasnik']);
			else $vlasnik="";
		if(isset($_POST['a_upis'])) $upis=mysqli_real_escape_string($msqli,$_POST['a_upis']);
			else $upis="";
		if(isset($_POST['a_proizvodjac'])) $proizvodjac=mysqli_real_escape_string($msqli,$_POST['a_proizvodjac']);
			else $proizvodjac="";
		if(isset($_POST['a_model'])) $model=mysqli_real_escape_string($msqli,$_POST['a_model']);
			else $model="";
		if(isset($_POST['a_tip'])) $tip=mysqli_real_escape_string($msqli,$_POST['a_tip']);
			else $tip="";
		if(isset($_POST['a_serijski'])) $serijski=mysqli_real_escape_string($msqli,$_POST['a_serijski']);
			else $serijski="";
		if(isset($_POST['a_godina'])) $godina=mysqli_real_escape_string($msqli,$_POST['a_godina']);
			else $godina="";
		if(isset($_POST['a_pogon'])) $pogon=mysqli_real_escape_string($msqli,$_POST['a_pogon']);
			else $pogon="";
		if(isset($_POST['a_gasmod'])) $gasmod=mysqli_real_escape_string($msqli,$_POST['a_gasmod']);
			else $gasmod="";
		if(isset($_POST['a_gasbroj'])) $gasbroj=mysqli_real_escape_string($msqli,$_POST['a_gasbroj']);
			else $gasbroj="";
		if(isset($_POST['a_gassonda'])) $gassonda=mysqli_real_escape_string($msqli,$_POST['a_gassonda']);
			else $gassonda="";
		if(isset($_POST['a_nosivost'])) $nosivost=mysqli_real_escape_string($msqli,$_POST['a_nosivost']);
			else $nosivost="";
		if(isset($_POST['a_radnihsati'])) $radnihsati=mysqli_real_escape_string($msqli,$_POST['a_radnihsati']);
			else $radnihsati="";
		if(isset($_POST['a_ravnoteza'])) $ravnoteza=mysqli_real_escape_string($msqli,$_POST['a_ravnoteza']);
			else $ravnoteza="";
		if(isset($_POST['a_tezina'])) $tezina=mysqli_real_escape_string($msqli,$_POST['a_tezina']);
			else $tezina="";
		if(isset($_POST['a_radijus'])) $radijus=mysqli_real_escape_string($msqli,$_POST['a_radijus']);
			else $radijus="";
		if(isset($_POST['a_prolaz'])) $prolaz=mysqli_real_escape_string($msqli,$_POST['a_prolaz']);
			else $prolaz="";
		if(isset($_POST['a_brzina'])) $brzina=mysqli_real_escape_string($msqli,$_POST['a_brzina']);
			else $brzina="";
		if(isset($_POST['a_pojas'])) $pojas=mysqli_real_escape_string($msqli,$_POST['a_pojas']);
			else $pojas="";
		if(isset($_POST['a_kran1'])) $kran1=mysqli_real_escape_string($msqli,$_POST['a_kran1']);
			else $kran1="";
		if(isset($_POST['a_kran2'])) $kran2=mysqli_real_escape_string($msqli,$_POST['a_kran2']);
			else $kran2="";
		if(isset($_POST['a_kran3'])) $kran3=mysqli_real_escape_string($msqli,$_POST['a_kran3']);
			else $kran3="";
		if(isset($_POST['a_kran4'])) $kran4=mysqli_real_escape_string($msqli,$_POST['a_kran4']);
			else $kran4="";
		if(isset($_POST['a_kran5'])) $kran5=mysqli_real_escape_string($msqli,$_POST['a_kran5']);
			else $kran5="";
		if(isset($_POST['a_kran6'])) $kran6=mysqli_real_escape_string($msqli,$_POST['a_kran6']);
			else $kran6="";
		if(isset($_POST['a_viljuske1'])) $viljuske1=mysqli_real_escape_string($msqli,$_POST['a_viljuske1']);
			else $viljuske1="";
		if(isset($_POST['a_viljuske2'])) $viljuske2=mysqli_real_escape_string($msqli,$_POST['a_viljuske2']);
			else $viljuske2="";
		if(isset($_POST['a_viljuske3'])) $viljuske3=mysqli_real_escape_string($msqli,$_POST['a_viljuske3']);
			else $viljuske3="";
		if(isset($_POST['a_viljuske4'])) $viljuske4=mysqli_real_escape_string($msqli,$_POST['a_viljuske4']);
			else $viljuske4="";
		if(isset($_POST['a_viljuske5'])) $viljuske5=mysqli_real_escape_string($msqli,$_POST['a_viljuske5']);
			else $viljuske5="";
		if(isset($_POST['a_motor1'])) $motor1=mysqli_real_escape_string($msqli,$_POST['a_motor1']);
			else $motor1="";
		if(isset($_POST['a_motor2'])) $motor2=mysqli_real_escape_string($msqli,$_POST['a_motor2']);
			else $motor2="";
		if(isset($_POST['a_motor3'])) $motor3=mysqli_real_escape_string($msqli,$_POST['a_motor3']);
			else $motor3="";
		if(isset($_POST['a_motor4'])) $motor4=mysqli_real_escape_string($msqli,$_POST['a_motor4']);
			else $motor4="";
		if(isset($_POST['a_motor5'])) $motor5=mysqli_real_escape_string($msqli,$_POST['a_motor5']);
			else $motor5="";
		if(isset($_POST['a_motor6'])) $motor6=mysqli_real_escape_string($msqli,$_POST['a_motor6']);
			else $motor6="";
		if(isset($_POST['a_motor7'])) $motor7=mysqli_real_escape_string($msqli,$_POST['a_motor7']);
			else $motor7="";
		if(isset($_POST['a_baterija1'])) $baterija1=mysqli_real_escape_string($msqli,$_POST['a_baterija1']);
			else $baterija1="";
		if(isset($_POST['a_baterija2'])) $baterija2=mysqli_real_escape_string($msqli,$_POST['a_baterija2']);
			else $baterija2="";
		if(isset($_POST['a_baterija3'])) $baterija3=mysqli_real_escape_string($msqli,$_POST['a_baterija3']);
			else $baterija3="";
		if(isset($_POST['a_felne1'])) $felne1=mysqli_real_escape_string($msqli,$_POST['a_felne1']);
			else $felne1="";
		if(isset($_POST['a_felne2'])) $felne2=mysqli_real_escape_string($msqli,$_POST['a_felne2']);
			else $felne2="";
		if(isset($_POST['a_felne3'])) $felne3=mysqli_real_escape_string($msqli,$_POST['a_felne3']);
			else $felne3="";
		if(isset($_POST['a_felne4'])) $felne4=mysqli_real_escape_string($msqli,$_POST['a_felne4']);
			else $felne4="";
		if(isset($_POST['a_felne5'])) $felne5=mysqli_real_escape_string($msqli,$_POST['a_felne5']);
			else $felne5="";
		if(isset($_POST['a_felne6'])) $felne6=mysqli_real_escape_string($msqli,$_POST['a_felne6']);
			else $felne6="";
		if(isset($_POST['a_gume1'])) $gume1=mysqli_real_escape_string($msqli,$_POST['a_gume1']);
			else $gume1="";
		if(isset($_POST['a_gume2'])) $gume2=mysqli_real_escape_string($msqli,$_POST['a_gume2']);
			else $gume2="";
		if(isset($_POST['a_gume3'])) $gume3=mysqli_real_escape_string($msqli,$_POST['a_gume3']);
			else $gume3="";
		if(isset($_POST['a_gume4'])) $gume4=mysqli_real_escape_string($msqli,$_POST['a_gume4']);
			else $gume4="";
		if(isset($_POST['a_gume5'])) $gume5=mysqli_real_escape_string($msqli,$_POST['a_gume5']);
			else $gume5="";
		if(isset($_POST['a_gume6'])) $gume6=mysqli_real_escape_string($msqli,$_POST['a_gume6']);
			else $gume6="";
		if(isset($_POST['a_gume7'])) $gume7=mysqli_real_escape_string($msqli,$_POST['a_gume7']);
			else $gume7="";
		if(isset($_POST['a_gume8'])) $gume8=mysqli_real_escape_string($msqli,$_POST['a_gume8']);
			else $gume8="";
		if(isset($_POST['a_signal1'])) $signal1=mysqli_real_escape_string($msqli,$_POST['a_signal1']);
			else $signal1="";
		if(isset($_POST['a_signal2'])) $signal2=mysqli_real_escape_string($msqli,$_POST['a_signal2']);
			else $signal2="";
		if(isset($_POST['a_signal3'])) $signal3=mysqli_real_escape_string($msqli,$_POST['a_signal3']);
			else $signal3="";
		if(isset($_POST['a_signal4'])) $signal4=mysqli_real_escape_string($msqli,$_POST['a_signal4']);
			else $signal4="";
		if(isset($_POST['a_napomena'])) $napomena=mysqli_real_escape_string($msqli,$_POST['a_napomena']);
			else $napomena="";
